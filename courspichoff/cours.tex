...
\newcommand{\marge}[1]{\marginpar{\parbox[b]{\marginparwidth}{\textsl{\small{#1}}}}}
...
\NewEnviron{voir}[1]{
  \marge{\begin{bclogo}[logo=\bcrosevents,barre=none,noborder=true]{\small Représentation - #1 }
    \BODY
  \end{bclogo}}}
...
\NewEnviron{dem}{
  \small\begin{Demonstration}
    \begin{upshape}
      \ \\\large\eleve \BODY\ \\ {\hspace*{0pt}\hfill$\square$}
    \end{upshape}
  \end{Demonstration}}
...
\NewEnviron{exercice}{\underline{\textsf{Exercice}}\ \\ \sffamily \small\BODY}
\NewEnviron{correction}{ \eleve \sffamily \small\footnotesize  \underline{Correction} \\ \BODY}
...
\NewEnviron{cit}[3]{
  ...
  \begin{flushright}
    \textit{#1}\\
    \textbf{#2}\ \underline{#3}\ {\BODY}\vspace{1cm}
  \end{flushright}}

\NewEnviron{cita}[3]{
  {\center\textit{#1}}
  \begin{flushright}
    \textbf{#2}\ \underline{#3}\ {\BODY}
  \end{flushright}}
...
\def\ie{\mathrel{\hbox{\ineg 6}}} 
\def\le{\mathrel{\hbox{\ineg 6}}} 
\def\leq{\mathrel{\hbox{\ineg 6}}} 
\def\se{\mathrel{\hbox{\ineg >}}} 
\def\ge{\mathrel{\hbox{\ineg >}}} 
\def\geq{\mathrel{\hbox{\ineg >}}} 
\def\vide{\hbox{\vid ?}}
\def\dim{{\rm dim}\,}
...
\def\Der#1#2{\Frac{\hbox{d}#1}{\hbox{d}#2}}
